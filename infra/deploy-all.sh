...
echo "[Paso 2 de 4] Desplegando código de la API al App Service ($APP_NAME)..."
...
echo "===================================================================="
echo "⚠️  Paso manual pendiente antes de que la creación de casos funcione:"
echo "    ejecutar contra la base '$CASES_FUNCTION_NAME' el CREATE USER ... FROM"
